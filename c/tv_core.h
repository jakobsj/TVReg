...
void tvreg_gpbb_core(double *xk,double *fxk,double *hxk,double *gxk,double *fxkl,double *k,Atype A,double *b,double alpha,double tau,double epsb_rel,int k_max,Dtype D,int ctype,double *d,double *c, int ghxl, int xl,double *hxkl,double *gxkl,double *xlist,int K,double beta,double sigma,int verbose,double* numGrad,double* numBack,double* numFunc);
